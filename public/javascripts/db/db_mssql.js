                ...
                if (err) {
                    ...
                    if (!rolledBack) {
                        transaction.rollback(err => {
                            ...
                            {
                                func("transact is failed,but rollback is successed!","rollback success!");
                            }
                                                    
                        }) 
                        //func(err);                        
                    }else{
                        func("transact is error,and no rollback!")
                    }
                } else {
                    transaction.commit(err => {
                                            // ... error checks 
                        if (err) {
                            func("commit is error,and reason is "+err);
                        }else{
                            func("","commit is successed!");
                        }
